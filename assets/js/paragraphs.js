...
const paragraphs = [ 
     ...
     "He couldn't move. His head throbbed and spun. He couldn't decide if it was the flu or the drinking last night. It was probably a combination of both.",
       ...
       "Where do theyget a random he wondered as he clicked the generate button.Do they just write a randomr do they get it somewhere? At that moment he read the randomnd realized it was about random paragraphs and his world would never be the same.",
     ...
     "It was a weird concept. Why would I really need to generate a randomCould I actually learn something from doing so? All these questions were running through her head as she pressed the generate button. To her surprise, she found what she least expected to see.",
     ...
     "I haven't bailed on writing. Look, I'm generating a randomt this very moment in an attempt to get my writing back on track. I am making an effort. I will start writing consistently again!",
     ...
     "I'm meant to be writing at this moment. What I mean is, I'm meant to be writing something else at this moment. The documenI'mmeant to be writing is, of course, open in another program on my computer and is ptiently awaiting my attention. Yet here I am plonking down senseless sentiments in thisecause it's easier to do than to work on anything particularly meaningful. I am grateful for the distraction.",
     ...
     "He stepped away from the mic. This was the best take he had done so far, but something seemed missing. Then it struck him all at once. Visuals ran in front of his eyes and music rang in his ears. His eager fingers went to work in an attempt to capture his thoughts hoping the results would produce something that was at least half their glory.",
       ...
       "The paper was blnk. It shouldn't have been. There should have been writing on the paper, at least af not more. The fact that the writing wasn't there was frustrating. Actually, it was even more than frustrating. It was downright distressing.",
     ...
     "It all started with a random letter. Several of tho wee joined forces to create a random word. The words decided to get together and frm a random sentence. They decided not to stop there and it wasn't long before a randomad been cobbled together. The question was whether or not they could continue the momentum long enough to create a random short story.",
